...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			INHIBITOR_MISSING_BOT_PERMS: missing => `Insufficient permissions, missing: **${missing}**, try doing >>invite and reinviting me to the server with full permissions.`,
			...
			COMMAND_INVITE: () => [
				`To invite Zero Two to your Discord server, use this link:`,
				`https://discordapp.com/oauth2/authorize?client_id=536702606857469953&scope=bot&permissions=2146958847`,
			],
			COMMAND_INVITE_DESCRIPTION: 'Displays the invite link of the bot, to invite it to your guild.',
			COMMAND_INFO: [
				"Zero Two is a Discord bot built on the KlasaJS framework which is built on top of the Discord.js library.",
				'Commands are modularized, allowing users to easily learn and adopt commands with a large array of different features available.',
				'',
				'You can find more information on Zero Two at these links:',
				'• 🌐 **Homepage:** https://github.com/jmoisxhi/Zero-Two',
				'• 🎚🎛 **Invite link:** Just do >>invite',
				'• 💬 **Issues / Bugs:** https://github.com/jmoisxhi/Zero-Two/issues',
				'• ⏲ **Commands and Features:** https://github.com/jmoisxhi/Zero-Two/wiki',
			],
			...
			DEPRECATED_COMMAND_MESSAGE: 'Hi,\nI\'ve been away from Discord for a while but with the freetime that I had I cleaned up the codebase for the bot.\n\nOf course, that involved changing commands and adding new ones, so some of the old commands have been removed and the one you just used happens to be one of them, but fear not!\n\nYou can find a definitive list of all the new commands by going to the link on my username / heading to the link on >>info or just simply doing >>help.\n\n**(NOTE:** >>urban [searchWord] is now >>define urban [searchWord]**)**',
			SIGNATURE: 'Sincerely,\nMixi'
		};
	}
