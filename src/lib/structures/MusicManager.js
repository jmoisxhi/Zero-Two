...
class MusicManager {
  ...
  constructor(guild) {
     ...
     */
    Reflect.defineProperty(this, 'client', { value: guild.client });

    /**
     * The CerasusGuild instance that manages this instance
     * @since 1.0.0
     * @type {CerasusGuild}
     * @name MusicManager#guild
     */
    Reflect.defineProperty(this, 'guild', { value: guild });
  ...
  /**
   * The VoiceChannel Cerasus is connected to
   * @since 1.0.0
   * @type {?VoiceChannel}
   * @readonly
   */
  ...
  /**
   * Whether Cerasus is playing a song or not
   * @since 2.0.0
   * @type {boolean}
   * @readonly
   */
  ...
  /**
   * Whether Cerasus has the queue paused or not
   * @since 2.0.0
   * @type {?boolean}
   * @readonly
   */
  ...
  /**
   * Whether Cerasus is doing nothing
   * @since 2.0.0
   * @type {boolean}
   * @readonly
   */
  ...
  async play() {
    ...
    if (!this.connection) {
      await this.channel
        .send(`One second, I just need to set everything up...`)
